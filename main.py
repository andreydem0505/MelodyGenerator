...
parser = argparse.ArgumentParser(description='Generate melody MIDI file')
...
parser.add_argument('--ticks', type=int, default=96, help='Ticks per beat (default: 96)')
...
parser.add_argument('--output', type=str, default='result.mid', help='Output MIDI file (default: result.mid)')
...
mid = mido.MidiFile(type=0, ticks_per_beat=args.ticks)
