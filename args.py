...
def launch_options():
    ...
    parser.add_argument('--minor-chance', '-mc', type=float, default=0.4, help='Chance of minor chords (default: 0.4)')
    ...
    parser.add_argument('--meter', '-m', type=str, default='3/4', help='Time signature (default: 3/4)')
