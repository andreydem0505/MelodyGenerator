...
def args():
    ...
    parser.add_argument('--mode', '-m', type=int, default=1, help='Music mode: major (>0), minor (<0) or any (=0) (default: major)')
    parser.add_argument('--tonic', '-ton', type=int, default=None, choices=list(range(1, 13)) + list(range(-12, 0)),help='Tonic note: 1..12 for a major tonic, -12..-1 for a minor tonic (default: random)')
